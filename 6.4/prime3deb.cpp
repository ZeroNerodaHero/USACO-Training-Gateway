...
void printc(){
    for(int i = 0; i < 10; i++) cout << cind[i] << ' '; cout << endl;
    for(int i = 0; i < 10; i++) cout << lind[i] << ' '; cout << endl;
    for(int i = 0; i < 10; i++) cout << linf[i] << ' '; cout << endl;
    for(int i = 0; i < 10; i++) cout << mid[i] << ' '; cout << endl;
}
...
void dfs(int d){
    ...
    switch(d){
        ...
        case 1: 
            tc = tab[2][2];
            for(int i = 0; i <mid[tc]; i++){
                if(((primem[tc][i][0]&1) == 0) || (primem[tc][i][0] == 5))
                    continue;
                for(int j = 0; j < 5; j++){
                    tab[4-j][j] = primef[tc][i][j];
                }
                dfs(d+1);
            }
            break;
